...
export default function ProceedsBorrower() {
  ...
  const stateOptions = [
    'CA', 'AK', 'AL', 'AR', 'AZ', 'CO', 'CT', 'DC', 'DE', 'FL', 'GA', 'HI', 
          ...
          <form className="space-y-8">
            ...
            <section>
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="bg-green-600 px-3 py-1 rounded text-sm font-medium">Borrower</span>
              </div>
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="border-b border-gray-600">
                    <div className="flex space-x-0">
                      <input type="hidden" value={paymentType} data-schema-key="contacts.borrower_payees.0.type" />
                      <button
                        type="button"
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          data-schema-key="contacts.borrower_payees.0.name"
                        />
                      </div>
                      <div>
                    ...
                    <div className="grid grid-cols-1 gap-6">
                      <div>
                        ...
                        <input
                          type="text"
                          className="w-full px-3 py-2.5 bg-gray-700 border border-gray-500 rounded text-white text-sm focus:outline-none focus:border-blue-500"
                          data-schema-key="contacts.borrower_payees.0.reference_number"
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <input type="hidden" data-schema-key="contacts.borrower_payees.0.address.latitude" />
                      <input type="hidden" data-schema-key="contacts.borrower_payees.0.address.longitude" />
                        ...
                        <div className="md:col-span-2">
                          ...
                          <div className="relative">
                            <input
                              ...
                              className="w-full px-3 py-2.5 pr-10 bg-gray-700 border border-gray-500 rounded text-white text-sm focus:outline-none focus:border-blue-500"
                              data-schema-key="contacts.borrower_payees.0.address.address_1"
                            />
                            <i className="fa fa-times absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 cursor-pointer hover:text-red-400" title="Clear Mailing Address"></i>
                          </div>
                        </div>
                        <div>
                          ...
                          <input
                            type="text"
                            className="w-full px-3 py-2.5 bg-gray-700 border border-gray-500 rounded text-white text-sm focus:outline-none focus:border-blue-500"
                            data-schema-key="contacts.borrower_payees.0.address.address_2"
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                          ...
                          <input
                            type="text"
                            className="w-full px-3 py-2.5 bg-gray-700 border border-gray-500 rounded text-white text-sm focus:outline-none focus:border-blue-500"
                            data-schema-key="contacts.borrower_payees.0.address.city"
                          />
                        </div>
                        <div>
                          ...
                          <div className="relative">
                            <select
                              ...
                              data-schema-key="contacts.borrower_payees.0.address.state"
                            >
                              {stateOptions.map((state) => (
                                <option key={state} value={state} selected={state === 'CA'}>
                                  {state}
                                </option>
                              ))}
                            </select>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            inputMode="numeric"
                            className="w-full px-3 py-2.5 bg-gray-700 border border-gray-500 rounded text-white text-sm focus:outline-none focus:border-blue-500"
                            data-schema-key="contacts.borrower_payees.0.address.zipcode"
                          />
                        </div>
                      </div>
                    </div>

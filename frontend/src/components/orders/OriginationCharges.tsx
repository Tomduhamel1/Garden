...
export default function OriginationCharges() {
  ...
  const renderTableRow = (lineNumber: number) => {
    ...
    const isOtherCharges = lineNumber === 9;
    const prefix = isOtherCharges ? 'other_charges.0' : `line_${paddedNumber}`;
      ...
      <section className="flex-1 bg-gray-900 overflow-y-auto">
        <section className="py-8 px-10 pb-5 border-b border-gray-600 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-2xl font-semibold text-white">Origination Charges</h2>
              ...
              <div className="bg-gray-800 border border-gray-600 rounded-lg overflow-hidden">
                <table className="w-full text-sm">
                  ...
                  <tbody className="bg-gray-800">
                    {[1, 2, 3, 4, 5, 6, 7, 8, 9].map(lineNumber => renderTableRow(lineNumber))}
                  </tbody>

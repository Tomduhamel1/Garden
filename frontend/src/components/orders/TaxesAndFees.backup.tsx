      ...
      >
        ...
        <td className="py-3 px-4">
          <input 
            ...
            value={getValue(`cdfData.taxes_and_government_fees.${lineKey}.description`) || ''}
        ...
        <td className="py-3 px-4">
          <div className="relative">
            <input 
              ...
              value={getValue(`cdfData.taxes_and_government_fees.${lineKey}.paid_by_seller`) || ''}
              onChange={handleInputChange}
              onFocus={() => setActiveRow(lineNumber)}
            />
            {lineNumber > 1 && (
        ...
        <td className="py-3 px-4">
          <input 
            ...
            value={getValue(`cdfData.taxes_and_government_fees.${lineKey}.paid_by_others`) || ''}
            onChange={handleInputChange}
            onFocus={() => setActiveRow(lineNumber)}
          />
        </td>
